  ...
  console.log(userContent);
    ...
    const requestBody = {
      ...
      messages:[
        ...
        {role:"assistant",content:"Yor are an export in analyzing text into a one word emotion that describe the music that he will want to hear. the user will tell you a stroy or provide a couple of lines about how he feels"},
